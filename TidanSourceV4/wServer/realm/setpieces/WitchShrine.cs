...
{
    internal class WitchShrine : ISetPiece
    {

        private static readonly string Tile = "1Stone_WalkWay1";
        private static readonly string TileDark = "1Stone_WalkWay1";
        private static readonly string Stone = "1Stone_Walk1";
        private static readonly string PillarA = "Purple Pillar";
        private static readonly string PillarB = "Purple Pillar";
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            Entity skull = Entity.Resolve(world.Manager, "Witch Shrine"); //ShrineBoss!
