...
namespace wServer.realm.setpieces
{
    ...
    {
        private static readonly string Floor = "Light Cobblestone";
        private static readonly string Bridge = "Bridge";
        private static readonly string WaterA = "121Clear Water1";
        private static readonly string WaterB = "121Clear Water1";
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            for (int x = 0; x < w; x++) //Rendering
                for (int y = 0; y < h; y++)
                {
                    ...
                    {
                        Entity cyclops = Entity.Resolve(world.Manager, "Oasis Giant");
