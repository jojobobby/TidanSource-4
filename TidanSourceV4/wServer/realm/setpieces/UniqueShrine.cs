...
{
    internal class UniqueShrine : ISetPiece
    {
        private static readonly string Grass = "Light Sand";
        private static readonly string Tile = "2Stone_Brick2";
        private static readonly string TileDark = "2Stone_Brick2";
        private static readonly string Stone = "1Stone_Brick1";
        private static readonly string PillarA = "Red Pillar";
        private static readonly string PillarB = "Red Pillar";
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            Entity skull = Entity.Resolve(world.Manager, "Tree Shrine"); //Skulls!
