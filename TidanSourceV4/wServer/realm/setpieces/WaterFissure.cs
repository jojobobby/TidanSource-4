...
{
    internal class WaterFissure : ISetPiece
    {
        private static readonly string Lava = "121Clear Water1";
        private static readonly string Floor = "Partial Vertical Catwalk";

        private static readonly Loot chest = new Loot(
            new TierLoot(4, ItemType.Weapon, 0.3),
            new TierLoot(5, ItemType.Weapon, 0.2),
            new TierLoot(6, ItemType.Weapon, 1.1),
            new TierLoot(2, ItemType.Armor, 0.3),
            new TierLoot(3, ItemType.Armor, 1.2),
            new TierLoot(4, ItemType.Armor, 0.1),
            new TierLoot(1, ItemType.Ability, 0.3),
            new TierLoot(2, ItemType.Ability, 0.2),
            new TierLoot(3, ItemType.Ability, 1.1),
            new TierLoot(1, ItemType.Ring, 1.25),
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            Entity demon = Entity.Resolve(world.Manager, "Blue Demon");
