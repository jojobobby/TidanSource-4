...
namespace wServer.realm
{
    ...
    internal class Oryx : IDisposable
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> events = new List<Tuple<string, ISetPiece>>
        {
            ...
            Tuple.Create("Davy Jones", (ISetPiece) new EasterEvent()),
            Tuple.Create("Cultist of the Halls", (ISetPiece) new Cultist()),
            Tuple.Create("Mythical Nymph", (ISetPiece) new NymphSetpiece()),
            Tuple.Create("Primaeval The Ancient Totem", (ISetPiece) new GoldenTemple()),
            Tuple.Create("shtrs Bridge Sentinel", (ISetPiece) new SHTRSbridge()),
        };
            ...
            spawn = new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            {
                ...
                },
                {
                    WmapTerrain.LowPlains, Tuple.Create(
                        100, new[]
                        {
                            Tuple.Create("Hobbit Mage", 0.2),
                            Tuple.Create("Undead Hobbit Mage", 0.2),
                ...
                },
                {
                    WmapTerrain.LowSand, Tuple.Create(
                        100, new[]
                        {
                            Tuple.Create("Sandsman King", 0.2),
                ...
                },
                {
                    WmapTerrain.MidPlains, Tuple.Create(
                        100, new[]
                        {
                            ...
                            Tuple.Create("Pink Blob", 0.04),
                            Tuple.Create("Gray Blob", 0.04),
                            Tuple.Create("Earth Golem", 0.02),
                            Tuple.Create("Paper Golem", 0.02),
                            Tuple.Create("Big Green Slime", 0.05),
                            Tuple.Create("Swarm", 0.04),
                            Tuple.Create("Planted Carrot", 0.5),
                            Tuple.Create("Wasp Queen", 0.2),
                            Tuple.Create("Shambling Sludge", 0.03),
                            Tuple.Create("Orc King", 0.02)
                        })
                },
                {
                    WmapTerrain.MidForest, Tuple.Create(
                        100, new[]
                        {
                            ...
                            Tuple.Create("Metal Golem", 0.03),
                            Tuple.Create("Planted Carrot", 0.3),
                            Tuple.Create("Clockwork Golem", 0.03),
                ...
                },
                {
                    ...
                    100, new []
                    {
                        Tuple.Create("White Demon", 0.02),
                        Tuple.Create("Sprite God", 0.02),
                        Tuple.Create("Medusa", 0.01),
                        Tuple.Create("Ent God", 0.02),
                        Tuple.Create("Beholder", 0.02),
                        Tuple.Create("Bag Phoenix", 0.02),
                        Tuple.Create("Flying Brain", 0.02),
                        Tuple.Create("Slime God", 0.02),
                        Tuple.Create("Ghost God", 0.02),
                        Tuple.Create("Thunder Cloud", 0.02),
                        Tuple.Create("Rock Bot", 0.02),
                        Tuple.Create("Djinn", 0.02),
                        Tuple.Create("Beetle", 0.02),
                        Tuple.Create("Black Knight", 0.02),
                        Tuple.Create("Leviathan", 0.02),
        ...
        public bool CheckFinalQuests()
        {
            ...
            if (CountEnemies(
                "Hermit God", "lord of the Lost Lands", "Pentaract", "Lich", "Actual Lich",
                "Ent Ancient", "Actual Ent Ancient", "Ghost Ship",
                "Cultist of the Halls", "Mythical Nymph", "Primaeval The Ancient Totem", "Cube God", "Grand Sphinx", "Davy Jones") != 0) return false;
        ...
        public void CloseRealm()
        {
            ...
            foreach (var i in world.Players.Values)
            {
                SendMsg(i, "Well done mortal, you've really made me mad this time!", "#Oryx the Mad God");
                SendMsg(i, "Shut yo bitch ass up!", "#That Nigga");
                SendMsg(i, "ENOUGH IS ENOUGH, YOU WILL PARISH AT THE HANDS OF MY GUARDIAN!", "#Oryx the Mad God");
                SendMsg(i, "Awe Shit, Here we go again!", "#That Nigga");
            ...
            foreach (var i in world.Manager.Worlds.Values)
            {
                if (!(i is GameWorld))
                {
                    foreach (var p in i.Players.Values)
                        p.SendInfo($"{name} has spawned in Realm! At : ({pt.X}, {pt.Y})");
                }
            }
        ...
        {//"shtrs Bridge Sentinel"
            ...
            Tuple.Create("Mythical Nymph", new TauntData//"shtrs Bridge Sentinel"
            {
                numberOfEnemies = new[]
                {
                    "Assist me my Mythical Nymph! These mortals must die.",
                    "Pathetic mortals, Die to my best creation, Mythical Nymph arise!"
                },
                killed = new[]
                {
                    "My Nymph has fallen? How Impecible of you!",
                    "My Nymph! Thessial will make quick of you for this!"
                }
            }),
            Tuple.Create("shtrs Bridge Sentinel", new TauntData
            {
                numberOfEnemies = new[]
                {
                    "Avatar! Release your ascendants!",
                    "Bridge Sentinel! I call you for your protection!"
                },
                killed = new[]
                {
                    "You've Shattered the defender of the gate!",
                    "That sentinel wasn't enough? How pathetic!"
                }
            }),
            Tuple.Create("Primaeval The Ancient Totem", new TauntData
            {
                 spawn = new[]
                 {
                   "My Ancient Totem will guard me till the end!",
                   "My powerful Totem will destroy you mortals!"
                 },
                 numberOfEnemies = new[]
                 {
                    "Fools! There is no escape from my {COUNT} Ancient Totem!",
                    "My legion of {COUNT} Ancient Totem live only to protect me!"
                 },
                 killed = new[]
                 {
                    "{PLAYER}, You'll pay for what you have done!",
                    "{PLAYER}, You have destroyed one of my ancient protectors!",
                    "{PLAYER}, You will die for what you have done!"
                 }
            }),
             Tuple.Create("Cultist of the Halls", new TauntData
            {
                 spawn = new[]
                 {
                   "Cultist? How did you escape!",
                   "That damn Cult will never put fear into me!"
                 },
                 killed = new[]
                 {
                    "{PLAYER}, You've killed it for the best!",
                    "Poor Cultist, can't even kill a few mortals!",
                    "HAHA! I'll never see him again."
                 }
            }),
             ...
             Tuple.Create("Grand Sphinx", new TauntData
            {
                spawn = new[]
                {
                    "Ye Ghost Ship shall take you to his locker!",
                    "My Ghost Ship will make quick of you!"
                },
                killed = new[]
                {
                    "Ye Ghost Ship must return to the seas, it will return as promised."
                }
            }),
            ...
            /* Tuple.Create("shtrs Defense System", new TauntData
            {
                ...
                killed = new[]
                {
                    "This cannot be! How did my Avatar fail to destroy you mortals!",
                    "You naive imbecile, {PLAYER}! Without my Avatar, The King is able to be free!"
                }
            }),
