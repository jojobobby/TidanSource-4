...
namespace wServer.realm.entities.player
{
    partial class Player
    {
        ...
        public bool Activate(RealmTime time, Item item, UseItemPacket pkt)
        {
            ...
            foreach (ActivateEffect eff in item.ActivateEffects)
            {
                switch (eff.Effect)
                {
                    ...
                    case ActivateEffects.NonLootBox:
                        {
                            if (!(Owner is Vault))
                            {
                                SendInfo("You have to be in Vault to use this item.");
                                ...
                                case 0:
                                    {
                                        ...
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("500 credits has been added into your account.");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Gold1200:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 1200);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("1200 credits has been added into your account.");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Gold2600:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        ...
                                        Fame = db.UpdateCredit(Client.Account, 2600);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("2,600 credits has been added into your account.");
                                    }
                                    break;
                            }
                        }
                        break;
                    case ActivateEffects.Tokens10:
                        {
                            int Fame = Random.Next(0, 0);
                            switch (Fame)
                            {
                                case 0:
                                    {
                                        var db = new db.Database();
                                        int numOfTokens = 10;
                                        Fame = db.UpdateFortuneToken(Client.Account, numOfTokens);
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp(numOfTokens + " credits has been added into your account.");
                                    }
                                    break;
                            }
                        }
                                ...
                                case 0:
                                    {
                                        ...
                                        UpdateCount++;
                                        db.Dispose();
                                        SendHelp("5000 credits has been added into your account.");
                                    }
                                    break;
                            }
                        }
                    ...
                    case ActivateEffects.StatBoostAura:
                        {
                            ...
                            if (eff.UseDefMod)
                            {
                                amountSBA = (int)UseDefMod(eff.Amount, 0);
                                durationSBA = (int)(UseDefMod(eff.DurationSec) * 1200);
                                rangeSBA = UseDefMod(eff.Range);
                            }
                    ...
                    case ActivateEffects.ConditionEffectSelf:
                        {
                            ...
                            if (eff.UseDefMod)
                                durationCES = (int)(UseDefMod(eff.DurationSec) * 1000);
                    ...
                    case ActivateEffects.ConditionEffectAura:
                        {
                            ...
                            if (eff.UseDefMod)
                            {
                                durationCEA = (int)(UseDefMod(eff.DurationSec) * 1000);
                                rangeCEA = UseDefMod(eff.Range);
                            }
                    ...
                    case ActivateEffects.HealNova:
                        {
                            ...
                            if (eff.UseDefMod)
                            {
                                amountHN = (int)UseDefMod(eff.Amount, 0);
                                rangeHN = UseDefMod(eff.Range);
                            }
                    ...
                    case ActivateEffects.MagicNovaSeal:
                        {
                            ...
                            {
                                amountSBA = (int)UseDefMod(eff.Amount, 0);
                                durationSBA = (int)(UseDefMod(eff.DurationSec) * 1000);
                                rangeSBA = UseDefMod(eff.Range);
                            }
                            if (HasConditionEffect(ConditionEffectIndex.HPBoost))
                            {
                    ...
                    case ActivateEffects.GenericActivate:
                        ...
                        var duration =
                            ...
                            (eff.UseDefMod) ?
                            (int)(UseDefMod(eff.DurationSec) * 1000) :
        ...
        private float UseDefMod(float value, int offset = 1)
        {
            double totalDefense = Stats[3] + 2 * Boost[3];

            if (totalDefense < 25)
                return value;

            double m = (value < 0) ? -1 : 1;
            double n = (value * totalDefense / 150) + (value * m);
            n = Math.Floor(n * Math.Pow(10, offset)) / Math.Pow(10, offset);
            if (n - (int)n * m >= 1 / Math.Pow(10, offset) * m)
            {
                return ((int)(n * 10)) / 10.0f;
