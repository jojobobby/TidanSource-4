        ...
        #region 1stboss
            ...
            .Init("shtrs Bridge Sentinel",
                new State(
                    ...
                    new State("talk",
                        new Taunt("I must keep this realm protected, Leave at once!"),
                    ...
                    new State("SummonConstructs",
                        ...
                        new TossObject("shtrs Bridge Obelisk A", 6, 360, coolDown: 9999999),
                        new TossObject("shtrs Bridge Obelisk A", 6, 270, coolDown: 9999999),
                        new TossObject("shtrs Bridge Obelisk A", 6, 180, coolDown: 9999999),
                        new TossObject("shtrs Bridge Obelisk A", 6, 90, coolDown: 9999999),
                        new TimedTransition(2000, "grenade1")
                        ),
                    new State(
                        new Shoot(30, 30, fixedAngle: 0, projectileIndex: 5, coolDown: 500, coolDownOffset: 200),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(12, count: 3, shootAngle: 18, projectileIndex: 0, coolDown: 800),
                        new Shoot(11, count: 2, projectileIndex: 3, coolDown: 1600),
                        new EntitiesNotExistsTransition(999, "nextfam", "shtrs Bridge Obelisk A"),
                    new State("grenade1",
                   ...
                   new State(
                    ...
                    new State("nextfam2",
                        new Taunt("Your life is sealed!!"),
                        new Shoot(30, 30, fixedAngle: 0, projectileIndex: 5, coolDown: 4000, coolDownOffset: 4000),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Flash(0xFFFFFF, 1, 2),
                    ...
                    new State("spookded",
                        ...
                        new Taunt("Oryx! Archmage... THE KING! I have failed to protect you!"),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                ...
                new GoldLoot(100, 220),
               new MostDamagers(5,
                    LootTemplates.Tier13Loot()
                    ),
                    new MostDamagers(30,
                        new ItemLoot("Potion of Life", 1),
                        new ItemLoot("Potion of Defense", 1),
                        new ItemLoot("Potion of Wisdom", 0.4),
                        new ItemLoot("Potion of Attack", 0.6),//Annihilated protection
                        new ItemLoot("Potion of Dexterity", 0.6),
                        new ItemLoot("Potion of Vitality", 0.7),
                        new ItemLoot("Bracer of the Guardian", 0.0096),
                        new ItemLoot("Zulfiqar", 0.0050),
                        new ItemLoot("Annihilated protection", 0.0096)
                )
            )
                ...
                new State(
                    ...
                    new State("Wake",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            ...
                            new TimedTransition(2000, "Comment4")
                        ),
                        new State("Comment4",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new SetAltTexture(1),
