    ...
    partial class BehaviorDb
    {
        ...
        .Init("Limon the Sprite God",
             new State(
                 new ScaleHP(500),
                 new State("idle",
                     new Order(199, "Limon Element 1", "suicide"),
                     new Order(199, "Limon Element 2", "suicide"),
                     new Order(199, "Limon Element 3", "suicide"),
                     new Order(199, "Limon Element 4", "suicide"),
