...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Thunder Cloud",
                new State(
                  new DropPortalOnDeath("The Omen Portal", 5),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
                        ),
                    new Shoot(10, 3, 20, predictive: .5, coolDown: 500)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.16),
                new TierLoot(7, ItemType.Weapon, 0.15),
                new TierLoot(8, ItemType.Weapon, 0.14),
                new TierLoot(7, ItemType.Armor, 0.16),
                new TierLoot(8, ItemType.Armor, 0.15),
                new TierLoot(9, ItemType.Armor, 0.14),
                new TierLoot(3, ItemType.Ring, 0.14),
                new TierLoot(4, ItemType.Ring, 0.13),
                new Threshold(0.18,
                    new ItemLoot("Potion of Wisdom", 0.08)
                    )
            )
         .Init("Bag Phoenix",
            new State(
            ...
            new Threshold(0.01,
                new ItemLoot("Immortal Phoenix Feather", 0.02)
                )
            )
         .Init("Black Knight",
                new State(
                    new Spawn("Black Warrior", maxChildren: 2),
                ...
                new Threshold(0.18,
                    new ItemLoot("Health Potion", 0.9),
                new ItemLoot("Magic Potion", 0.9)
            )
            )
            .Init("Black Warrior",
                new State(
                     new DropPortalOnDeath("Manor of the Immortals Portal", 15),
                    new Shoot(10, predictive: 0.3),
                    new Prioritize(
                        new Protect(1.2, "Black Knight", 15, 10, 5),
                        new Follow(1.4, 10.5, 1.6, 2600, 2200),
                        new StayAbove(1.2, 160),
                        new Wander(0.4)
                        )
         ...
         .Init("Beetle",
                new State(
                    new DropPortalOnDeath("The Crawling Depths", 25),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
  ...
  new TierLoot(6, ItemType.Weapon, 0.06),
            ...
            .Init("Sprite Child",
                new State(
                    ...
                    new DropPortalOnDeath("Glowing Portal", 30)
                    )
            )
            .Init("Medusa",
                new State(
                    new DropPortalOnDeath("Snake Pit Portal", 30),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
  ...
  new TierLoot(6, ItemType.Weapon, 0.06),
            ...
            .Init("Ent God",
                new State(
                        new DropPortalOnDeath("Woodland Labyrinth", 25),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
        ...
        new TierLoot(6, ItemType.Weapon, 0.06),
                ...
                new TierLoot(3, ItemType.Ability, 0.14),
                new Threshold(0.18,
                    new ItemLoot("Potion of Defense", 0.18)
                    )
            )
            .Init("Lucky Ent God",
                new State(
        ...
        new TierLoot(6, ItemType.Weapon, 0.06),
                ...
                new Threshold(0.18,
                    new ItemLoot("Potion of Defense", 0.10)
                    )
            )
            .Init("Beholder",
                new State(
                    new DropPortalOnDeath("The Grasslands Portal", 25),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
        ...
        new TierLoot(6, ItemType.Weapon, 0.16),
            ...
            .Init("Flying Brain",
                new State(
                    ...
                    new DropPortalOnDeath("Mad Lab Portal", 25)
                    ),
        new TierLoot(6, ItemType.Weapon, 0.16),
                new TierLoot(7, ItemType.Weapon, 0.15),
                new TierLoot(8, ItemType.Weapon, 0.14),
        ...
        new TierLoot(6, ItemType.Weapon, 0.16),
            ...
            .Init("Ghost God",
                new State(
                    ...
                    new DropPortalOnDeath("Undead Lair Portal", 25)
                    ),
        new TierLoot(6, ItemType.Weapon, 0.16),
                new TierLoot(7, ItemType.Weapon, 0.15),
                new TierLoot(8, ItemType.Weapon, 0.14),
        ...
        new TierLoot(6, ItemType.Weapon, 0.06),
            ...
            .Init("Paper Bot",
                ...
                new ItemLoot("Tincture of Life", 0.10)
            )
            .Init("Steel Bot",
                new State(
                    new Prioritize(
        ...
        new TierLoot(6, ItemType.Weapon, 0.16),
            ...
            .Init("Lucky Djinn",
                new State(
                    new DropPortalOnDeath("The Crawling Depths", 20),
                    new State("Idle",
                        new Prioritize(
                            new StayAbove(1, 200),
                            new Wander(0.8)
            ...
            .Init("Leviathan",
                new State(
                    new State("pattern walk",
                        ...
                        new State("1",
                            new Shoot(0, 3, 10, fixedAngle: 0, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 3, 10, fixedAngle: 120, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 3, 10, fixedAngle: 240, projectileIndex: 0, coolDown: 600),
                            new TimedTransition(1500, "2")
                            ),
                        new State("2",
                            new Shoot(0, 4, 10, fixedAngle: 40, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 4, 10, fixedAngle: 160, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 4, 10, fixedAngle: 280, projectileIndex: 0, coolDown: 600),
                            new TimedTransition(1500, "3")
                            ),
                        new State("3",
                            new Shoot(0, 4, 10, fixedAngle: 80, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 4, 10, fixedAngle: 200, projectileIndex: 0, coolDown: 600),
                            new Shoot(0, 4, 10, fixedAngle: 320, projectileIndex: 0, coolDown: 600),
