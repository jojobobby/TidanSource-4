        ...
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                ...
                new MostDamagers(30,
                    ...
                    new ItemLoot("Ghostly Hide Armor", 0.03),
                    new ItemLoot("Wine Cellar Incantation", 0.005),
                    new ItemLoot("NecroST0", 0.0087),
                    new ItemLoot("NecroST1", 0.0085),
                    new ItemLoot("NecroST2", 0.0087),
                    new ItemLoot("NecroST3", 0.0087),
                    new ItemLoot("Lair loot bag", 0.10),
