            ...
            .Init("Archdemon Malphas",
               ...
               new MostDamagers(30,
                   new ItemLoot("Potion of Defense", 1.0),
                    ...
                    new ItemLoot("Abyss loot bag", 0.1),
                    new ItemLoot("Blade of the Warrior", 0.008),
                    new ItemLoot("Solid Demonic Shield", 0.008),
                    new ItemLoot("Demon Scale Armor", 0.008),
                    new ItemLoot("Hard Clay Crown", 0.008),
                    new ItemLoot("Heated Demon Hide", 0.01)
                        ),
                new MostDamagers(7,
