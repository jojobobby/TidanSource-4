        ...
        private _ OryxCastle = () => Behav()
            .Init("Oryx Stone Guardian Right",
                ...
                new MostDamagers(30,
                    ...
                    new ItemLoot("Heavy Plated Robe", 0.01),
                    new ItemLoot("Ring of the Guardian", 0.01),
            ...
            .Init("Oryx Stone Guardian Left",
                new State(
                 ...
                 new MostDamagers(30,
                    new ItemLoot("Ancient Stone Sword", 0.02),
                    new ItemLoot("Skull of Solid Defense", 0.01),
                    new ItemLoot("Ancient Summoner Staff", 0.01),
                    new ItemLoot("Potion of Defense", 1),
                    new TierLoot(8, ItemType.Weapon, 0.1),
                    new TierLoot(7, ItemType.Armor, 0.1),
                    new TierLoot(3, ItemType.Ring, 0.1)
