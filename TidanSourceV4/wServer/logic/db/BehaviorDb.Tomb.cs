        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",
                new State(
                    ...
                    new MostDamagers(30,
                        //leg
                        new ItemLoot("Battle Attire", 0.017),
                        //ut
                    ...
                    new Suicide()
                        ...
                        .Init("Tomb Support Statue",
                                new State(
                                    new State("check",
                                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                        new TimedTransition(2500, "Active")
                                        ),
                                        new State("Active",
                                                new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                                new EntityNotExistsTransition("Tomb Defender", 50000, "Start")
                                        ),
                                        new State("Start",
                        ...
                        .Init("Tomb Attacker Statue",
                                new State(
                                    new State("check",
                                        ...
                                        new State("Active",
                                                new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                                new EntityNotExistsTransition("Tomb Defender", 50000, "Activ2e")
                                            ),
                                         new State("Activ2e",
                                                new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                                new EntityNotExistsTransition("Tomb Support", 50000, "Start")
                                        ),
                                        new State("Start",
                ...
                new ItemLoot("Geb's Ring of Wisdom", 0.02)
                        ...
                        .Init("Tomb Support",
                                ...
                                new MostDamagers(30,
                                        ...
                                        new ItemLoot("Potion of Life", 0.51),
                        ...
                        .Init("Tomb Attacker",
                                ...
                                new MostDamagers(30,
                                        new ItemLoot("Potion of Life", 1),
                                        new ItemLoot("Potion of Life", 0.51),
                                        new ItemLoot("Ring of the Sphinx", 0.028),
