            ...
            .Init("Lord of the Lost Lands",
                new State(
                    ...
                    new State("crystals",
                        new SetAltTexture(1),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new TossObject("Protection Crystal", 3, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Protection Crystal", 3, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Protection Crystal", 3, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Protection Crystal", 3, 270, coolDown: 9999999, randomToss: false),
                ...
                new MostDamagers(30,
                    ...
                    new ItemLoot("Staff of the Noble Pride", 0.009),
