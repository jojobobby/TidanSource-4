    ...
    partial class BehaviorDb
    {
        ...
        .Init("Murderous Megamoth",
             new State(
                 ...
                 new MostDamagers(20,
                    new ItemLoot("Potion of Vitality", 9),
                    new ItemLoot("Potion of Speed", 9)
                ),
                new MostDamagers(30,
                    ...
                    new ItemLoot("Environmental Spell", 0.009),
                    new ItemLoot("Robe of the Cadet", 0.01),
                    new ItemLoot("Leaf Bow", 0.027)
                ),
                new Threshold(0.2
                )
            )
