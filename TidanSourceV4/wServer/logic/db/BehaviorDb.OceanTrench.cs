    ...
    partial class BehaviorDb
    {
        _ OceanTrench = () => Behav()
                ...
                new State(
                    ...
                    new State("Texture0",
                        ...
                        new MostDamagers(30,
                            ...
                            new ItemLoot("Royal Queen Robe", 0.004),
                   ...
                   new State("Spawning Bomb Attack2",
                    ...
                    new State("Attack2",
                       ...
                       new MostDamagers(30,
                            new ItemLoot("Coral Juice", 0.3),
                            new ItemLoot("Coral Bow", 0.01),
                            new ItemLoot("Royal Queen Robe", 0.01),
            ...
            .Init("Thessal the Mermaid Goddess Wounded",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Taunt("Is this Cakes source or Fsod?"),
                    new TimedTransition(12000, "Fail"),
                    new State("Texture1",
                        new ChatTransition("Prize", "Cakes"),
                        new ChatTransition("Prize", "cakes"),
                        new ChatTransition("Prize", "CAKES"),
                        new ChatTransition("Prize", "Cake"),
                        new ChatTransition("Prize", "cake"),
                        new SetAltTexture(1),
                    ...
                    new State("Fail",
                        new Taunt("All of those answers were wrong!"),
                        new TimedTransition(0, "Suicide")
                        ),
                    new State("Suicide",
                        new Suicide()
