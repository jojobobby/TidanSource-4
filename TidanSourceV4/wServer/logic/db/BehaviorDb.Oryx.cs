        ...
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                ...
                new MostDamagers(30,
                    ...
                    //EG
                    new ItemLoot("KnightST0", 0.019),
                    new ItemLoot("KnightST1", 0.019),
                    new ItemLoot("KnightST2", 0.019),
                    new ItemLoot("KnightST3", 0.019)
                ),
                new MostDamagers(30,
                    new TierLoot(10, ItemType.Weapon, 0.37),
                    new TierLoot(11, ItemType.Weapon, 0.36),
                    new TierLoot(12, ItemType.Weapon, 0.35),
                    new TierLoot(13, ItemType.Weapon, 0.25),
                    new TierLoot(5, ItemType.Ability, 0.37),
                    new TierLoot(6, ItemType.Ability, 0.35),
                    new TierLoot(11, ItemType.Armor, 0.37),
                    new TierLoot(12, ItemType.Armor, 0.36),
                    new TierLoot(13, ItemType.Armor, 0.35),
                    new TierLoot(5, ItemType.Ring, 0.36),
                    new ItemLoot("Cloak of Wild Shadows", 0.01)
                )
            )
