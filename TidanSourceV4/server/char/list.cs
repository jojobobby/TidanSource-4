        ...
        private List<ClassAvailabilityItem> GetClassAvailability(Account acc)
        {
            ...
            if (acc == null)
            {
                return new List<ClassAvailabilityItem>
                {
                    ...
                    new ClassAvailabilityItem {Class = "Samurai", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Archer", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Blade Master", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Wizard", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Overbound", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Priest", Restricted = "unrestricted"},
                    new ClassAvailabilityItem {Class = "Occultist", Restricted = "unrestricted"},
            ...
            using (Database db = new Database())
            {
                ...
                if (!rdr.HasRows)
                {
                    ...
                    foreach (string s in classes)
                    {
                        ...
                        xcmd.Parameters.AddWithValue("@restricted", s == "Wizard" ? "unrestricted" : "unrestricted");
                        xcmd.ExecuteNonQuery();
                        ret.Add(new ClassAvailabilityItem
                        {
                            Class = s,
                            Restricted = s == "Wizard" ? "unrestricted" : "unrestricted"
                        });
                    }
                }
                else
