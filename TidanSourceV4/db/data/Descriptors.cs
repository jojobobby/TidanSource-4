...
public class ProjectileDesc
{
    public ProjectileDesc(XElement elem)
    {
        ...
        FaceDir = elem.Element("FaceDir") != null;
...
public class ActivateEffect
{
    public ActivateEffect(XElement elem)
    {
        ...
        UseDefMod = elem.Attribute("useDefMod") != null;
    ...
    public bool UseDefMod { get; private set; }
...
public class Item : IFeedable
{
    ...
    public Item(ushort type, XElement elem)
    {
        try
        {
            ...
            HalfHPBerserk = elem.Element("HalfHPBerserk") != null;
            Immune2Dazed = elem.Element("Immune2Dazed") != null;
            StunImmune = elem.Element("StunImmune") != null;
            HealItem = elem.Element("HealItem") != null;
            LE1Ability = elem.Element("LE1Ability") != null;
            HalfHPArmored = elem.Element("HalfHPArmored") != null;
            Health24 = elem.Element("Health24") != null;
            HalfMPAImmune = elem.Element("HalfMPAImmune") != null;
            MPabovehalf = elem.Element("MPabovehalf") != null;
            HPabovehalf = elem.Element("HPabovehalf") != null;
            BurstDamage = elem.Element("BurstDamage") != null;
            ImmunePara = elem.Element("ImmunePara") != null;
            NearbyDefBoost = elem.Element("NearbyDefBoost") != null;
            HpBelowonet3 = elem.Element("HpBelowonet3") != null;//DexBoostHp//HPBoostMp
            TeleportLowHp = elem.Element("TeleportLowHp") != null;
            HPBoostMp = elem.Element("HPBoostMp") != null;
            DexBoostHp = elem.Element("DexBoostHp") != null;
            ...
            LG = elem.Element("Legendary") != null;
            ET = elem.Element("Epic") != null;
            RT = elem.Element("Rare") != null;
            UCT = elem.Element("Uncommon") != null;
            CT = elem.Element("Common") != null;
            IsBackpack = elem.Element("Backpack") != null;
			Healer = elem.Element("Healer") != null;
			Obliterator = elem.Element("Obliterator") != null;
    ...
    public bool HalfHPArmored { get; private set; }
    public bool LE1Ability { get; private set; }
    public bool StunImmune { get; private set; }
    public bool HealItem { get; private set; }

    public bool Health24 { get; private set; }
    public bool Immune2Dazed { get; private set; }
    public bool HalfHPBerserk { get; private set; }
    public bool ImmunePara { get; private set; }
    public bool BurstDamage { get; private set; }
    public bool HalfMPAImmune { get; private set; }
    public bool HPabovehalf { get; private set; }
    public bool MPabovehalf { get; private set; }
    public bool NearbyDefBoost { get; private set; }
    public bool TeleportLowHp { get; private set; }
    public bool HPBoostMp { get; private set; }
    public bool DexBoostHp { get; private set; }
    public bool HpBelowonet3 { get; private set; }
    ...
    public bool ET { get; private set; }
    public bool RT { get; private set; }
    public bool UCT { get; private set; }
    public bool CT { get; private set; }
    public bool IsBackpack { get; private set; }
	public bool Obliterator { get; private set; }
	public bool Healer { get; private set; }
