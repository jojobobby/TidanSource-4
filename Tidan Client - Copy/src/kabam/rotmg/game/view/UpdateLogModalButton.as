...
public class UpdateLogModalButton extends Sprite {
    public static const IMAGE_NAME:String = "updatelogIcon";
    public static const IMAGE_ID:int = 1;
    ...
    public function UpdateLogModalButton() {
        mouseChildren = false;
        ...
        this.text.setStringBuilder(new StaticStringBuilder("Click to see current update log!"));
    ...
    public function onClick(_arg_1:MouseEvent):void {
        var _local_1:String = Parameters.UPDATE_LOG;
