...
public class TitleView extends Sprite {
    ...
    private function makeMenuOptionsBar():MenuOptionsBar {
        ...
        _local_6.addButton(_local_1, MenuOptionsBar.PLAY);
        _local_6.addButton(_local_2, MenuOptionsBar.SERVER);
        _local_6.addButton(_local_5, MenuOptionsBar.SUPPORT);
        _local_6.addButton(_local_3, MenuOptionsBar.ACCOUNT);
        _local_6.addButton(_local_4, MenuOptionsBar.LEGENDS);
        return (_local_6);
    }
