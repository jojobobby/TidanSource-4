...
public class QuestHealthBar extends Sprite
{
    ...
    {
        super();
        this.questBar = new StatusBar(194, 16, 12919330, 5526612, "Quest");
        this.questBar2 = new StatusBar(194, 16, 12919330, 5526612, "Quest");
        this.questBar3 = new StatusBar(194, 16, 12919330, 5526612, "Quest");
