...
import kabam.rotmg.game.view.UpdateLogModalButton;
...
public class GameSprite extends AGameSprite {
    ...
    // public var updatelogModalButton:UpdateLogModalButton;
    ...
    //  private function showUpdateLogIcon():void {
    //      this.updatelogModalButton = new UpdateLogModalButton();
    //       this.updatelogModalButton.x = 6;
    //       this.updatelogModalButton.y = (this.displaysPosY + 2);
    //       this.displaysPosY = (this.displaysPosY + UIUtils.NOTIFICATION_SPACE);
//        addChild(this.updatelogModalButton);
    //   }
    private function showSafeAreaDisplays():void {
        this.showRankText();
        this.showGuildText();
        this.showDiscordIcon();
        //  this.showUpdateLogIcon();
