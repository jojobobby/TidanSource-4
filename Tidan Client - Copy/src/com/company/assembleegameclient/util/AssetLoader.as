...
public class AssetLoader {
    ...
    private function addImages():void {
        AssetLibrary.addImageSet("32x32img", new EmbeddedAssets._32x32imgEmbed_().bitmapData, 32,32);
        ...
        AssetLibrary.addImageSet("textile10x10", new EmbeddedAssets.textile10x10Embed_().bitmapData, 8, 8);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("chars8x8rEncountersmoon", new EmbeddedAssets.chars8x8rEncountersmoonEmbed_().bitmapData, null, 8, 8, 56, 8, AnimatedChar.RIGHT);
        ...
        AnimatedChars.add("chars16x16rEncountersmoon", new EmbeddedAssets.chars16x16rEncountersmoonEmbed_().bitmapData, null, 16, 16, 112, 16, AnimatedChar.RIGHT);
