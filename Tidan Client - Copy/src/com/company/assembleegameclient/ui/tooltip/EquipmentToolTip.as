...
public class EquipmentToolTip extends ToolTip {
    ...
    private function makeItemPowerText():void {
        ...
        if (this.objectXML.hasOwnProperty("HalfHPBerserk")) {
            ...
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Strength: When equipped you get a Berserk buff when MP is at 100%.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("TeleportLowHp")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Power: When this item is equipped you gain a 20% attack boost when health is full.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Resurrects")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Undying: When equipped you Resurrect after death but this item is destroyed.")));
            this.powerText.filters =FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("BonusStatsDef")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Protection: When equipped you get a 25% def boost when hp is less than 25%.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HalfHPArmored")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Fortify: When equipped you get a healing buff when health is below 25%.")));
            this.powerText.filters =FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("LE1Ability")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Buff: When equipped you get +10 bonus to all stats when hp is below %50.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("AB")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Stat: When equipped you gain +10 of a stat.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HPabovehalf")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Alive: When equipped you get a major dexterity boost if health is full.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Rocketwarning1")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Fuel: This item will be destroyed if not used near the rocket, (Activates the rocket for 30 minutes).")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("ImmunePara")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Wings: When equipped you are immune to Paralyze if hp is higher than 1/3.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HPBoostMp")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Repair: When equipped all defense items that are on adds to your vitality as well.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Lootbox")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFFFF : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("When Used: This bag will give a random item listed in the description.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Health24")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Hero: When equipped you gain +25 vitality when health is below half.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("BurstDamage")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Rage: When equipped you get a damaging buff when hit by any projectile.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("MPabovehalf")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Knowledge: When equipped you get a +40 Wis boost if your Mana is 50% or higher.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("NearbyDefBoost")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Guard: When this item is equipped you gain 1 extra defense for each enemy 4 blocks around you.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("StunImmune")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Powerful: When this item is equipped you're immune to being stunned.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Immune2Dazed")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Predicted: When this item is equipped you're immune to the Debuff Dazed if Health is above 50%.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HalfMPAImmune")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("MagicBarrier: When equipped you're immune to Armor Break if mp is 50% full.")));
            this.powerText.filters = FilterUtil.getTextOutlineFilter();
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
    ...
    private function addTierText():void {
        ...
        if (((((_local_1) && (_local_2))) && (_local_3))) {
            ...
            if (_local_4) {
                ...
                if (this.objectXML.hasOwnProperty("ET1")) {
                    this.tierText.setColor(0xFFA500);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("EG1"));
                }
                else if (this.objectXML.hasOwnProperty("ET")) {
                    this.tierText.setColor(0xFFA500);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("EG"));
                }
                else if (this.objectXML.hasOwnProperty("epic")) {
                    this.tierText.setColor(0x800080);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("E"));
                }
                else if (this.objectXML.hasOwnProperty("rare")) {
                    this.tierText.setColor(0x008080);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("R"));
                }
                else if (this.objectXML.hasOwnProperty("common")) {
                    this.tierText.setColor(0xFFFFFF);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("C"));
                }
                ...
                else if (this.objectXML.hasOwnProperty("TI")) {
                    this.tierText.setColor(0xFFFFFF);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("TI"));
                }
                else if (this.objectXML.hasOwnProperty("LE")) {
                    this.tierText.setColor(0xD2691E);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("LE"));
                }
                else if (this.objectXML.hasOwnProperty("LR")) {
                    this.tierText.setColor(0xFFB6C1);
    ...
    private function addEquipmentItemRestrictions():void {
        if (this.objectXML.hasOwnProperty("Treasure") == false) {
           // this.restrictions.push(new Restriction(TextKey.EQUIP_TO_USE, 0xB3B3B3, true));
            if (((this.isInventoryFull) || ((this.inventoryOwnerType == InventoryOwnerTypes.CURRENT_PLAYER)))) {
                this.restrictions.push(new Restriction(TextKey.DOUBLE_CLICK_EQUIP, 0xB3B3B3, true));
            }
            else {
               this.restrictions.push(new Restriction(TextKey.DOUBLE_CLICK_TAKE, 0xB3B3B3, true));
            }
        }
    }
    ...
    private function makeRestrictionList():void
    {
        ...
        if (this.objectXML.hasOwnProperty("Soulboundddd"))
        {
        ...
        if (this.objectXML.hasOwnProperty("Obliterator")) {
            this.tierText.setColor(0xFF0000);
            if (this.objectXML.hasOwnProperty("@theme")) {
                var _ability2:String = this.objectXML.attribute("theme");


                var _rarityTopText2:String = "Effect";
                var _rarityTopColor2:uint = 0xFF0000;
                var _rarityTopBold2:Boolean = true;
                var _rarityBottomText2:String = "This item's effect is : " + _ability2 ;
                var _rarityBottomColor2:uint = 0x8b0000;
                var _rarityBottomBold2:Boolean = false;

                this.restrictions.push(new Restriction(_rarityTopText2, _rarityTopColor2, _rarityTopBold2));
                this.restrictions.push(new Restriction(_rarityBottomText2, _rarityBottomColor2, _rarityBottomBold2));
            }
            var _abilitytopText2:String = _ability2;
            var _abilitytopColor2:uint = 0xFFD700;
            var _abilitytopBold2:Boolean = true;
            var _Oblierater:String = "There is a 5% chance of recieving a damaging buff and berserk buff for 2.5 seconds."
            var _abilitybottomColor2:uint = 0xEEDD82;
            var _abilitybottomBold2:Boolean = false;

            this.restrictions.push(new Restriction(_abilitytopText2, _abilitytopColor2, _abilitytopBold2));
            this.restrictions.push(new Restriction(_Oblierater, _abilitybottomColor2, _abilitybottomBold2));
        }
        if (this.objectXML.hasOwnProperty("Healer")) {
            this.tierText.setColor(0xFFFF00);
            if (this.objectXML.hasOwnProperty("@theme")) {
                var _ability:String = this.objectXML.attribute("theme");


                var _rarityTopText:String = "Effect";
                var _rarityTopColor:uint = 0xFFFF00;
                var _rarityTopBold:Boolean = true;
                var _rarityBottomText:String = "This item's effect is : " + _ability ;
                var _rarityBottomColor:uint = 0x9b870c;
                var _rarityBottomBold:Boolean = false;

                this.restrictions.push(new Restriction(_rarityTopText, _rarityTopColor, _rarityTopBold));
                this.restrictions.push(new Restriction(_rarityBottomText, _rarityBottomColor, _rarityBottomBold));
            }
            var _abilitytopText:String = _ability;
            var _abilitytopColor:uint = 0xf4feef;
            var _abilitytopBold:Boolean = true;
            var _healer:String = "There is a 10% chance of healing buff for 2.5 seconds."
            var _abilitybottomColor:uint = 0xffffff;
            var _abilitybottomBold:Boolean = false;

            this.restrictions.push(new Restriction(_abilitytopText, _abilitytopColor, _abilitytopBold));
            this.restrictions.push(new Restriction(_healer, _abilitybottomColor, _abilitybottomBold));
        }
        if (this.playerCanUse) {
            ...
            if (this.objectXML.hasOwnProperty("LG")) {
                this.restrictions.push(new Restriction(("Speciality: Legendary "), 0xFFFF00, false));
                this.descText.setColor(0xffff00);
                this.titleText.setColor(0xffff00);
                this.tierText.setColor(0xffff00);
                this.effectsText.setColor(0xffff00);
            }

            if (this.objectXML.hasOwnProperty("TI")) {
                this.restrictions.push(new Restriction(("Speciality: True Item "), 0xeaf0ff, false));
                this.descText.setColor(0xeaf0ff);
                this.titleText.setColor(0xeaf0ff);
                this.tierText.setColor(0xeaf0ff);
                this.effectsText.setColor(0xeaf0ff);
            }
            if (this.objectXML.hasOwnProperty("LE")) {
                this.restrictions.push(new Restriction(("Speciality: Limited Edition "), 0xD2691E, false));
                this.descText.setColor(0xD2691E);
                this.titleText.setColor(0xD2691E);
                this.tierText.setColor(0xD2691E);
                this.effectsText.setColor(0xD2691E);
            }
            if (this.objectXML.hasOwnProperty("LR")) {
                this.restrictions.push(new Restriction(("Speciality: Legendary Rare "), 0xFFB6C1, false));
                this.descText.setColor(0xFFB6C1);
                this.titleText.setColor(0xFFB6C1);
                this.tierText.setColor(0xFFB6C1);
                this.effectsText.setColor(0xFFB6C1);
            }
            else if (this.objectXML.hasOwnProperty("ET")) {
                this.restrictions.push(new Restriction(("Speciality: Epic"), 0xFFA500, false));
                this.descText.setColor(0xFFA500);
                this.titleText.setColor(0xFFA500);
                this.tierText.setColor(0xFFA500);
                this.effectsText.setColor(0xFFA500);
            }
            else if (this.objectXML.hasOwnProperty("RT")) {
                this.restrictions.push(new Restriction(("Speciality: Rare"), 0x0000ff, false));
                this.descText.setColor(0x0000ff);
                this.titleText.setColor(0x0000ff);
                this.tierText.setColor(0x0000ff);
                this.effectsText.setColor(0x0000ff);
            }
            else if (this.objectXML.hasOwnProperty("UCT")) {
                this.restrictions.push(new Restriction(("Speciality: Uncommon"), 0x008000, false));
                this.descText.setColor(0x008000);
                this.titleText.setColor(0x008000);
                this.tierText.setColor(0x008000);
                this.effectsText.setColor(0x008000);
            }

            else if (this.objectXML.hasOwnProperty("CT")) {
                this.restrictions.push(new Restriction(("Speciality: Common"), 0xFFFFFF, false));
                this.descText.setColor(0xFFFFFF);
                this.titleText.setColor(0xFFFFFF);
                this.tierText.setColor(0xffffff)
                this.effectsText.setColor(0xffffff);;
            }
            else {
