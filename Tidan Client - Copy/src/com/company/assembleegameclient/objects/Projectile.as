...
public class Projectile extends BasicObject {
    ...
    override public function draw(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:int):void {
        ...
        _local_4 = TextureRedrawer.redraw(_local_4, 230, true, _local_7);

        this.staticVector3D_.x = x_;
        this.staticVector3D_.y = y_;
        this.staticVector3D_.z = z_;
        var _loc7_:Number = !!this.projProps_.faceDir_?Number(this.getDirectionAngle(_arg_3)):Number(this.angle_);
        var _loc6_:Number = !!this.projProps_.noRotation_?Number(_arg_2.angleRad_ + this.props_.angleCorrection_):Number(_local_6 - _arg_2.angleRad_ + this.props_.angleCorrection_ + _local_5);
